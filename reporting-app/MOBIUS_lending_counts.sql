...
SELECT
    ...
    WHERE l.loan_date between '2025-01-01' and '2025-07-01' and l.current_item_permanent_location_campus_name = 'University of Missouri - Kansas City' and l.checkout_service_point_name like 'DCB%'
