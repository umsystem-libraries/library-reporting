...
WHERE l.loan_due_date::date <= due_date and l.current_item_permanent_location_library_name like campus_prefix ||'%'and l.checkout_service_point_name like 'DCB%' and l.loan_status <> 'Closed'
$$
LANGUAGE SQL
STABLE
PARALLEL SAFE;
