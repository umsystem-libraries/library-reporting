...
WHERE ci.item_status_prior_to_check_in = 'Available' and ci.request_queue_size = '0' and ll.location_name like (campus_code ||'%') and start_date <= ci.occurred_date_time::date AND ci.occurred_date_time::date < end_date
